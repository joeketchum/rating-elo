...
{
	if (region.bS.a5 === region.cd.a5)
	{
		return 'on line ' + region.bS.a5;
	}
	return 'on lines ' + region.bS.a5 + ' through ' + region.cd.a5;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dz: 'hidden', dl: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dz: 'mozHidden', dl: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dz: 'msHidden', dl: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dz: 'webkitHidden', dl: 'webkitvisibilitychange' }
		: { dz: 'hidden', dl: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.dI, request.eg, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cg: fragment, cm: host, cC: path, cG: port_, cJ: protocol, cK: query};
	});
...
var $robinheghan$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {aB: charsProcessed, aI: hash, cT: seed, aO: shift};
	});
...
var $robinheghan$murmur3$Murmur3$finalize = function (data) {
	var acc = (!(!data.aI)) ? (data.cT ^ A2(
		$robinheghan$murmur3$Murmur3$multiplyBy,
		$robinheghan$murmur3$Murmur3$c2,
		A2(
			$robinheghan$murmur3$Murmur3$rotlBy,
			15,
			A2($robinheghan$murmur3$Murmur3$multiplyBy, $robinheghan$murmur3$Murmur3$c1, data.aI)))) : data.cT;
	var h0 = acc ^ data.aB;
	...
	function (c, data) {
		...
		if (_v0 === 24) {
			return {
				aB: data.aB + 1,
				aI: 0,
				cT: A2($robinheghan$murmur3$Murmur3$mix, data.cT, res),
				aO: 0
			};
		} else {
			return {aB: data.aB + 1, aI: res, cT: data.cT, aO: data.aO + 8};
		}
	});
...
var $author$project$Player$decoder = A5(
	...
	F4(
		function (id_, name_, rating_, matches) {
			return {a3: id_, as: matches, bq: name_, a9: rating_};
		}),
	A2(
			...
			[
				...
				F2(
					function (newPlayers, ignored) {
						return {T: $elm$core$Maybe$Nothing, C: ignored, r: newPlayers};
					}),
				...
				function (playersDict) {
					return {T: $elm$core$Maybe$Nothing, C: _List_Nil, r: playersDict};
				},
				A2(
					$elm$json$Json$Decode$map,
					$rtfeldman$elm_sorter_experiment$Sort$Dict$fromList($author$project$Player$idSorter),
	...
	function (toResult, response) {
		switch (response.$) {
			...
			case 3:
				...
				return $elm$core$Result$Err(
					$elm$http$Http$BadStatus(metadata.d6));
			default:
				var body = response.b;
				return A2(
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{dd: false, di: r.di, du: r.du, ck: r.ck, dI: r.dI, eb: r.eb, c1: r.c1, eg: r.eg}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{di: $elm$http$Http$emptyBody, du: r.du, ck: _List_Nil, dI: 'GET', eb: $elm$core$Maybe$Nothing, c1: $elm$core$Maybe$Nothing, eg: r.eg});
};
var $author$project$History$History = $elm$core$Basics$identity;
var $author$project$History$init = F2(
	function (retention, initial) {
		return {L: initial, ao: _List_Nil, ag: _List_Nil, cQ: retention};
	});
...
var $author$project$League$init = {
	...
	C: _List_Nil,
	r: $rtfeldman$elm_sorter_experiment$Sort$Dict$empty($author$project$Player$idSorter)
};
...
var $author$project$League$nextMatch = function (_v0) {
	var league = _v0;
	var allPlayersRaw = $rtfeldman$elm_sorter_experiment$Sort$Dict$values(league.r);
	var allPlayers = A2(
...
var $author$project$Main$init = function (_v0) {
	...
	var httpRequest = $elm$http$Http$get(
		{
			du: A2($elm$http$Http$expectJson, $author$project$Main$GotPlayers, $author$project$League$decoder),
			eg: url
		});
...
var $author$project$Main$IgnoredKey = {$: 22};
...
var $author$project$Player$setRating = F2(
	function (rating_, _v0) {
		...
		return _Utils_update(
			player,
			{
				a9: A2($elm$core$Basics$max, 0, rating_)
			});
	});
	...
	function (player, _v0) {
		...
		var initialRating = function () {
			var _v1 = A2(
				...
				$rtfeldman$elm_sorter_experiment$Sort$Dict$values(league.r));
			if (!_v1.b) {
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'name',
				$elm$json$Json$Encode$string(player.bq)),
				_Utils_Tuple2(
				'rating',
				$elm$json$Json$Encode$int(player.a9)),
				_Utils_Tuple2(
				'matches',
				$elm$json$Json$Encode$int(player.as))
			]));
};
...
var $author$project$League$updateRatingsIncludingPlayInPeriod = F2(
	function (ratings, players_) {
		var playerBInPlayInPeriod = _Utils_cmp(
			$author$project$Player$matchesPlayed(players_.cF),
			$author$project$League$playInMatches) < 0;
		var playerAInPlayInPeriod = _Utils_cmp(
			$author$project$Player$matchesPlayed(players_.cE),
			$author$project$League$playInMatches) < 0;
		return {
			cE: ((!playerAInPlayInPeriod) && playerBInPlayInPeriod) ? players_.cE : $author$project$Player$incrementMatchesPlayed(
				A2($author$project$Player$setRating, ratings.cE, players_.cE)),
			cF: ((!playerBInPlayInPeriod) && playerAInPlayInPeriod) ? players_.cF : $author$project$Player$incrementMatchesPlayed(
				A2($author$project$Player$setRating, ratings.cF, players_.cF))
		};
	});
...
var $author$project$League$finishMatch = F2(
	function (outcome, league) {
		if (!outcome.$) {
			var won = outcome.a.c7;
			var lost = outcome.a.cu;
			var newRatings = A2(
				$author$project$Elo$win,
				A2($author$project$League$kFactor, league, won),
				{
					cu: $author$project$Player$rating(lost),
					c7: $author$project$Player$rating(won)
				});
			var newPlayers = A2(
				$author$project$League$updateRatingsIncludingPlayInPeriod,
				{cE: newRatings.c7, cF: newRatings.cu},
				{cE: won, cF: lost});
			return $author$project$League$clearMatch(
				A2(
					$author$project$League$updatePlayer,
					newPlayers.cF,
					A2($author$project$League$updatePlayer, newPlayers.cE, league)));
		} else {
			var playerA = outcome.a.cE;
			var playerB = outcome.a.cF;
			var newRatings = A2(
				...
				{
					cE: $author$project$Player$rating(playerA),
					cF: $author$project$Player$rating(playerB)
				});
			var newPlayers = A2(
				$author$project$League$updateRatingsIncludingPlayInPeriod,
				newRatings,
				{cE: playerA, cF: playerB});
			return $author$project$League$clearMatch(
				A2(
					$author$project$League$updatePlayer,
					newPlayers.cF,
	...
	if (_v1.b) {
		...
		return A2($elm$core$Basics$composeL, $elm$core$Maybe$Just, $elm$core$Basics$identity)(
			_Utils_update(
				...
				{
					L: mostRecent,
					ao: A2($elm$core$List$cons, guts.L, guts.ao),
					ag: rest
				}));
	} else {
		return $elm$core$Maybe$Nothing;
		...
		return A2($elm$core$Basics$composeL, $elm$core$Maybe$Just, $elm$core$Basics$identity)(
			_Utils_update(
				guts,
				{
					L: nextRecent,
					ao: rest,
					ag: A2($elm$core$List$cons, guts.L, guts.ag)
				}));
	} else {
		return $elm$core$Maybe$Nothing;
	}
...
var $author$project$League$ignorePlayer = F2(
	function (player, _v0) {
		...
		return A2($elm$core$List$member, pid, league.C) ? league : _Utils_update(
			league,
			{
				C: A2($elm$core$List$cons, pid, league.C)
			});
	});
var $author$project$Player$init = function (name_) {
	return {
		a3: A2($robinheghan$murmur3$Murmur3$hashString, 0, name_),
		as: 0,
		bq: name_,
		a9: $author$project$Elo$initialRating
	};
};
		...
		return _Utils_update(
			guts,
			{
				...
				ag: A2(
					$elm$core$List$take,
					guts.cQ,
					A2($elm$core$List$cons, guts.L, guts.ag))
			});
	});
				...
				T: function () {
					...
					if (_v1.$ === 1) {
						...
						return (_Utils_eq(
							...
							$author$project$Player$id(player),
							$author$project$Player$id(b))) ? $elm$core$Maybe$Nothing : league.T;
					}
				}(),
				C: A2(
					$elm$core$List$filter,
								...
								model,
								{
									b: A2(
										...
										$author$project$League$addPlayer(
											$author$project$Player$init(model.aM)),
										model.b),
									aM: ''
								}),
							$elm$core$Platform$Cmd$none)));
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								W: $elm$core$Maybe$Just('Failed to load standings: ' + problem)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 15:
				...
				if (!_v4.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								W: $elm$core$Maybe$Just('Saved standings malformed or unreadable')
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 17:
...
var $author$project$Main$ClearStatus = {$: 20};
var $author$project$Main$KeeperWantsToLoadStandings = {$: 10};
var $author$project$Main$KeeperWantsToSaveStandings = {$: 8};
var $author$project$Main$KeeperWantsToSaveToDrive = {$: 9};
var $author$project$Main$ToggleAutoSave = {$: 18};
var $rtfeldman$elm_css$Css$Structure$Compatible = 0;
var $rtfeldman$elm_css$Css$auto = {dc: 0, c: 0, aF: 0, bm: 0, dF: 0, aJ: 0, ac: 0, U: 0, aN: 0, P: 0, bA: 0, aS: 0, I: 0, X: 'auto'};
...
var $rtfeldman$elm_css$Css$prop6 = F7(
	function (key, argA, argB, argC, argD, argE, argF) {
		return A2($rtfeldman$elm_css$Css$property, key, argA.X + (' ' + (argB.X + (' ' + (argC.X + (' ' + (argD.X + (' ' + (argE.X + (' ' + argF.X))))))))));
	});
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.dn) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.bq, record.dn, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	var charset = _v0.b7;
	var imports = _v0.cn;
	var namespaces = _v0.cw;
	var declarations = _v0.$7;
	return {
		b7: charset,
		$7: $rtfeldman$elm_css$Css$Structure$compactDeclarations(declarations),
		cn: imports,
		cw: namespaces
	};
};
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {b7: charset, $7: declarations, cn: imports, cw: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {b7: $elm$core$Maybe$Nothing, cn: _List_Nil, cw: _List_Nil, cW: snippets};
};
...
var $rtfeldman$elm_css$Css$inset = {F: 0, X: 'inset'};
...
var $rtfeldman$elm_css$Css$prop2 = F3(
	function (key, argA, argB) {
		return A2($rtfeldman$elm_css$Css$property, key, argA.X + (' ' + argB.X));
	});
...
var $rtfeldman$elm_css$Css$pointer = {c: 0, X: 'pointer'};
...
var $rtfeldman$elm_css$Css$zero = {o: 0, aJ: 0, ac: 0, aK: 0, aL: 0, aq: 0, ar: 0, a7: 0, af: 0, bt: 0, aT: '', bf: 0, X: '0'};
...
var $author$project$Main$blueButton = $author$project$Main$button(
	$rtfeldman$elm_css$Css$hex('0091FF'));
...
var $rtfeldman$elm_css$Css$borderBox = {bE: 0, bi: 0, X: 'border-box'};
...
var $rtfeldman$elm_css$Css$initial = {b_: 0, s: 0, a_: 0, b0: 0, az: 0, b1: 0, aA: 0, Z: 0, F: 0, bi: 0, S: 0, c: 0, l: 0, aF: 0, bH: 0, a1: 0, bl: 0, am: 0, B: 0, aG: 0, g: 0, ab: 0, bm: 0, cq: 0, bK: 0, o: 0, aJ: 0, ac: 0, aK: 0, aL: 0, aq: 0, ar: 0, U: 0, bo: 0, e: 0, d: 0, bN: 0, a7: 0, af: 0, bt: 0, aN: 0, P: 0, bA: 0, aQ: 0, av: 0, aR: 0, aS: 0, aw: 0, I: 0, aT: '', bf: 0, X: 'initial', bg: 0, aj: 0};
...
var $author$project$Main$KeeperWantsToRedo = {$: 13};
var $author$project$Main$KeeperWantsToSkipMatch = {$: 5};
var $author$project$Main$KeeperWantsToUndo = {$: 12};
...
var $rtfeldman$elm_css$Css$stringsToValue = function (list) {
	return $elm$core$List$isEmpty(list) ? {X: 'none'} : {
		X: A2($elm$core$String$join, ', ', list)
	};
};
...
var $rtfeldman$elm_css$Css$hidden = {F: 0, aN: 0, X: 'hidden', bg: 0};
...
var $rtfeldman$elm_css$Css$prop4 = F5(
	function (key, argA, argB, argC, argD) {
		return A2($rtfeldman$elm_css$Css$property, key, argA.X + (' ' + (argB.X + (' ' + (argC.X + (' ' + argD.X))))));
	});
var $rtfeldman$elm_css$Css$padding4 = $rtfeldman$elm_css$Css$prop4('padding');
var $author$project$History$peekBack = function (_v0) {
	var guts = _v0;
	return $elm$core$List$head(guts.ag);
};
var $author$project$History$peekForward = function (_v0) {
	var guts = _v0;
	return $elm$core$List$head(guts.ao);
};
...
var $rtfeldman$elm_css$Css$fixed = {a_: 0, a8: 0, bA: 0, X: 'fixed'};
var $rtfeldman$elm_css$Css$inlineBlock = {l: 0, X: 'inline-block'};
...
var $rtfeldman$elm_css$Css$block = {l: 0, X: 'block'};
...
var $rtfeldman$elm_css$Css$collapse = {b4: 0, X: 'collapse', bg: 0};
...
var $rtfeldman$elm_css$Css$none = {az: 0, b2: 0, F: 0, c: 0, l: 0, dA: 0, cp: 0, bK: 0, aL: 0, aq: 0, U: 0, e: 0, d: 0, bN: 0, bt: 0, dY: 0, P: 0, bu: 0, d3: 0, aQ: 0, aw: 0, I: 0, i: 0, ef: 0, X: 'none'};
...
var $rtfeldman$elm_css$Css$prop3 = F4(
	function (key, argA, argB, argC) {
		return A2($rtfeldman$elm_css$Css$property, key, argA.X + (' ' + (argB.X + (' ' + argC.X))));
	});
...
var $rtfeldman$elm_css$Css$calc = F3(
	function (firstExpr, expression, secondExpr) {
		var withoutCalcStr = function (l) {
			return A2($elm$core$String$startsWith, 'calc(', l.X) ? A2($elm$core$String$dropLeft, 4, l.X) : l.X;
		};
		...
		var value = A2(
			...
			_List_fromArray(
				[calcs]));
		return {b5: 0, aF: 0, B: 0, o: 0, aJ: 0, ac: 0, aK: 0, aL: 0, aq: 0, ar: 0, U: 0, aR: 0, X: value};
	});
...
var $rtfeldman$elm_css$Css$solid = {F: 0, av: 0, X: 'solid'};
var $rtfeldman$elm_css$Css$transparent = {S: 0, X: 'transparent'};
...
var $author$project$Main$view = function (model) {
	return {
									...
									[
										...
										_List_fromArray(
											[
												...
												A2(
												$author$project$Main$goldButton,
												model.ak ? 'Auto-save: On' : 'Auto-save: Off',
		...
		ec: 'The Rating Game ❤️'
	};
};
var $author$project$Main$main = $elm$browser$Browser$document(
	{dD: $author$project$Main$init, d8: $author$project$Main$subscriptions, ee: $author$project$Main$update, eh: $author$project$Main$view});
